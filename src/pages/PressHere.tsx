...
const HandoffCtx = createContext<React.MutableRefObject<Handoff>>(
  { current: { page4Dots: null, page5Dots: null, page6Dots: null, ch2p2Dots: null } }
)
...
function Chapter2Page2() {
  ...
  useEffect(() => {
    ...
    const step = () => {
      ...
      // Keep handoff updated so the next page inherits the live roaming state
...
// ─── Chapter 2 Page 3 — triangle (was Page 4) ────────────────────────────────
...
function Chapter2Page3() {
  ...
  useEffect(() => {
    ...
    if (src && src.length === BURST_COUNT) {
      // Inherit exact live positions/velocities from Page 2
...
export default function PressHere() {
  ...
  const handoffRef     = useRef<Handoff>({ page4Dots: null, page5Dots: null, page6Dots: null, ch2p2Dots: null })
  ...
  function reset() {
    ...
    setWellDone(false)
    setChapter(1)
    handoffRef.current = { page4Dots: null, page5Dots: null, page6Dots: null, ch2p2Dots: null }
  }
