    ...
    <div style={{ padding: "24px 40px 40px", background: "#fafafa", minHeight: "100%", position: "relative" }}>
      ...
      <section style={{ marginBottom: 32 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
          ...
          <a href="#" style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 14, color: "#00d4aa", textDecoration: "none", fontWeight: 500 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 16 }}>
          ...
          >
            <div style={{ width: 56, height: 56, borderRadius: 12, background: "linear-gradient(135deg, #e8fbf9 0%, #d4f5f0 100%)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              <svg width={28} height={28} viewBox="0 0 24 24" fill="none" stroke="#00d4aa" strokeWidth={1.5}>
        ...
        <section>
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <p style={{ margin: "0 0 12px", fontSize: 14, color: "#666", lineHeight: 1.4 }}>
              ...
              <a href="#" style={{ color: "#00d4aa", textDecoration: "none" }}>View more</a>
            </p>
          ...
          <div style={{ padding: 20 }}>
            <div
              style={{
                height: 140,
                borderRadius: 8,
                background: "linear-gradient(135deg, #e8fbf9 0%, #00d4aa 50%, #ff8c42 100%)",
                marginBottom: 16,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
              ...
              <a href="#" style={{ fontSize: 14, color: "#00d4aa", textDecoration: "none", fontWeight: 500 }}>Learn more</a>
            </div>
          </div>
        </section>
      </div>
